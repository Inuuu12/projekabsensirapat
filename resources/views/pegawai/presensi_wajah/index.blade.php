    ...
    <main class="flex-grow w-full max-w-[1680px] mx-auto px-4 sm:px-6 lg:px-8 2xl:px-10 py-12 flex flex-col items-center justify-center">
        ...
        <div class="bg-white border border-gray-200/80 rounded-3xl p-6 md:p-8 max-w-2xl w-full shadow-lg relative space-y-6 text-center">
            ...
            @elseif ($agendaAktif && $agendaAktif->isKuotaPenuh())
                <div class="rounded-2xl border border-red-200 bg-red-50 p-6 text-center space-y-3 my-4">
                    ...
                    <p class="text-xs font-medium text-red-700 leading-relaxed">Presensi Face Recognition untuk agenda ini telah ditutup karena kuota maksimal peserta telah terpenuhi.</p>
                </div>
            @else
