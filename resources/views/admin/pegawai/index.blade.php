...
<div class="max-w-[1400px] mx-auto space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-xs sm:text-sm text-gray-500 mt-1">Kelola data pegawai dinas dan publik BAPPENDA.</p>
        </div>
        <button onclick="openModal('modal-tambah-pegawai')" class="bg-[#22C55E] hover:bg-[#16A34A] text-white font-bold py-2.5 px-5 rounded-xl flex items-center justify-center gap-2 transition shadow-xs cursor-pointer self-start sm:self-auto">
    ...
    <div class="flex flex-col md:flex-row justify-between items-stretch md:items-center gap-4 bg-white p-4 rounded-2xl border border-gray-100 shadow-xs">
        <div class="flex flex-wrap items-center gap-3">
            ...
            <div class="relative flex-1 min-w-[200px]">
                ...
                <input type="text" class="bg-gray-50 text-gray-700 text-xs rounded-xl block w-full pl-9 p-2.5 outline-none border border-transparent focus:border-[#35635b] focus:bg-white transition" placeholder="Cari pegawai...">
            </div>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-xs border border-gray-100 overflow-hidden">
            ...
            <table class="w-full text-left border-collapse min-w-[1000px]">
                ...
                <tbody class="divide-y divide-gray-100 text-xs sm:text-sm">
                    <tr class="hover:bg-gray-50/80 transition">
                        ...
                        <td class="px-6 py-4 text-gray-600 font-mono">19750817 200012 1 002</td>
                        <td class="px-6 py-4 text-gray-700 font-medium">Kepala Badan</td>
                        <td class="px-6 py-4 text-gray-700">Sekretariat</td>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center items-center gap-2">
                                <button onclick="openModal('modal-edit-pegawai')" class="p-2 bg-green-50 text-green-600 rounded-lg hover:bg-green-100 transition cursor-pointer">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                </button>
                                <button onclick="openModal('modal-hapus-pegawai')" class="p-2 bg-red-50 text-red-600 rounded-lg hover:bg-red-100 transition cursor-pointer">
                    ...
                    <tr class="hover:bg-gray-50/80 transition">
                        ...
                        <td class="px-6 py-4 text-gray-600 font-mono">19800322 200501 2 005</td>
                    ...
                    <tr class="hover:bg-gray-50/80 transition">
                        <td class="px-6 py-4 font-bold text-gray-500">3</td>
                        <td class="px-6 py-4">
                            <div class="w-9 h-9 rounded-full bg-[#35635b]/20 flex items-center justify-center font-bold text-[#35635b]">BS</div>
                        </td>
                        <td class="px-6 py-4 font-bold text-gray-800">Budi Santoso, S.Kom.</td>
                        <td class="px-6 py-4 text-gray-600 font-mono">19851110 201004 1 001</td>
                        <td class="px-6 py-4 text-gray-700 font-medium">Kepala Bidang</td>
                        <td class="px-6 py-4 text-gray-700">Pajak Daerah I</td>
                        <td class="px-6 py-4 text-gray-700 font-mono">081333212465</td>
                        <td class="px-6 py-4 text-gray-600">budisantoso@gmail.com</td>
                        <td class="px-6 py-4">
                            <div class="flex justify-center items-center gap-2">
                                <button onclick="openModal('modal-edit-pegawai')" class="p-2 bg-green-50 text-green-600 rounded-lg hover:bg-green-100 transition cursor-pointer">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
        ...
        <div class="px-6 py-4 bg-gray-50/50 border-t border-gray-100 flex justify-between items-center text-xs text-gray-500 font-medium">
            <span>Menampilkan 1 sampai 3 dari 120 pegawai</span>
        </div>
    </div>
</div>
...
<div id="modal-tambah-pegawai" class="fixed inset-0 z-50 bg-black/50 hidden items-center justify-center p-4">
    <div class="bg-white rounded-2xl max-w-lg w-full p-6 shadow-xl space-y-4">
        ...
        <form class="space-y-4" onsubmit="event.preventDefault(); closeModal('modal-tambah-pegawai');">
            <div>
                <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Nama Lengkap</label>
                <input type="text" class="w-full border border-gray-300 rounded-xl p-2.5 text-sm focus:border-[#35635b] outline-none" placeholder="Nama pegawai beserta gelar">
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1">NIP</label>
                    <input type="text" class="w-full border border-gray-300 rounded-xl p-2.5 text-sm focus:border-[#35635b] outline-none" placeholder="1980...">
                </div>
                <div>
                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Jabatan</label>
                    <input type="text" class="w-full border border-gray-300 rounded-xl p-2.5 text-sm focus:border-[#35635b] outline-none" placeholder="Jabatan">
                </div>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Bidang</label>
                    <input type="text" class="w-full border border-gray-300 rounded-xl p-2.5 text-sm focus:border-[#35635b] outline-none" placeholder="Bidang">
                </div>
                <div>
                    <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Kontak (WA)</label>
            ...
            <div>
                ...
                <input type="email" class="w-full border border-gray-300 rounded-xl p-2.5 text-sm focus:border-[#35635b] outline-none" placeholder="email@bappenda.go.id">
            </div>
            <div class="flex justify-end gap-3 pt-3 border-t">
                ...
                <button type="submit" class="px-4 py-2 text-sm font-bold text-white bg-[#35635b] hover:bg-[#2b4f49] rounded-xl shadow-xs">Simpan Pegawai</button>
            </div>
        </form>
    </div>
</div>
...
<div id="modal-edit-pegawai" class="fixed inset-0 z-50 bg-black/50 hidden items-center justify-center p-4">
    <div class="bg-white rounded-2xl max-w-lg w-full p-6 shadow-xl space-y-4">
        <h3 class="text-lg font-bold text-gray-800 border-b pb-3">Edit Data Pegawai</h3>
        <form class="space-y-4" onsubmit="event.preventDefault(); closeModal('modal-edit-pegawai');">
            <div>
                <label class="block text-xs font-bold text-gray-700 uppercase mb-1">Nama Lengkap</label>
...
<!-- Modal Hapus Pegawai -->
<div id="modal-hapus-pegawai" class="fixed inset-0 z-50 bg-black/50 hidden items-center justify-center p-4">
    <div class="bg-white rounded-2xl max-w-sm w-full p-6 shadow-xl text-center space-y-4">
        ...
        <h3 class="text-base font-bold text-gray-800">Hapus Data Pegawai?</h3>
        <p class="text-xs text-gray-500">Apakah Anda yakin ingin menghapus data pegawai ini?</p>
        <div class="flex justify-center gap-3 pt-2">
            <button onclick="closeModal('modal-hapus-pegawai')" class="px-4 py-2 text-sm font-semibold text-gray-600 hover:bg-gray-100 rounded-xl">Batal</button>
            <button onclick="closeModal('modal-hapus-pegawai')" class="px-4 py-2 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-xl shadow-xs">Hapus</button>
        </div>
    </div>
</div>
