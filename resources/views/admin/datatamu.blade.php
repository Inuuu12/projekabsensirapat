...
<body class="bg-gray-100 font-sans antialiased flex min-h-screen">
            ...
            <nav class="space-y-1 text-sm">
                ...
                <div>
                    ...
                    <div class="pl-9 mt-1 space-y-1 text-xs">
                        <a href="/admin/datapegawai" class="block py-2 opacity-80 hover:opacity-100">Data Pegawai</a>
                        <!-- Submenu Data Tamu Aktif (Style Oval Grayish) -->
                        <a href="/admin/datatamu" class="block py-2 px-3 font-bold bg-white/20 rounded-lg text-white">Data Tamu</a>
                    </div>
                </div>
    ...
    <main class="flex-1 p-8 overflow-y-auto">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h2 class="text-3xl font-extrabold text-gray-800 tracking-tight">Data Tamu</h2>
