...
<body class="bg-gray-100 font-sans antialiased flex min-h-screen">
            ...
            <nav class="space-y-1 text-sm">
                ...
                <div>
                    ...
                    <div class="pl-9 mt-1 space-y-1 text-xs">
                        <a href="/admin/agenda" class="block py-2 opacity-80 hover:opacity-100">Daftar Agenda</a>
                        <!-- Submenu Daftar Ruang Aktif sesuai Mockup (Gaya Oval/Pill Grayish) -->
                        <a href="/admin/ruang" class="block py-2 px-3 font-bold bg-white/20 rounded-lg text-white">Daftar Ruang</a>
                    </div>
                </div>

                <!-- Menu Lainnya -->
                <div class="flex items-center justify-between px-4 py-3 rounded-lg opacity-80 hover:opacity-100 transition-all font-medium cursor-pointer">
                    <div class="flex items-center space-x-3">
    ...
    <main class="flex-1 p-8 overflow-y-auto">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                <h2 class="text-3xl font-extrabold text-gray-800 tracking-tight">Daftar Ruangan</h2>
                <p class="text-xs text-gray-400 mt-1">Selamat datang kembali, Admin!</p>
            </div>
            <!-- Profile Card Bulat Lonjong sesuai Gambar -->
            <div class="flex items-center space-x-3 bg-[#3b6f6c]/10 px-4 py-2 rounded-full border border-[#3b6f6c]/20 max-w-xs shadow-sm">
                ...
                <span class="text-[#3b6f6c] bg-white rounded-full p-0.5 text-[8px] border shadow-xs">⚙️</span>
            </div>
        </div>
