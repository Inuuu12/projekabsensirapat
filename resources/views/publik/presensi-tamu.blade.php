        ...
        <div class="bg-white border border-gray-200/80 rounded-3xl p-6 md:p-8 max-w-lg w-full shadow-lg relative space-y-6">
            ...
            @elseif ($agendaAktif && $agendaAktif->isKuotaPenuh())
                <div class="rounded-2xl border border-red-200 bg-red-50 p-6 text-center space-y-3">
                    ...
                    <p class="text-xs font-medium text-red-700 leading-relaxed">Pendaftaran kehadiran tamu telah ditutup karena kuota maksimal peserta agenda ini telah terpenuhi.</p>
                </div>
            @elseif ($agendaAktif)
